...
const About = () => {
  useDocumentTitle('About Us - ResumeAI Pro');
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setAnimatedStats(prev => ({
        ...
        interviewRate: Math.min(prev.interviewRate + 1, 85),
        atsRate: Math.min(prev.atsRate + 1, 95),
  ...
  const stats = [
    ...
    { 
      icon: FiTarget, 
      value: animatedStats.interviewRate, 
          ...
          >
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                ...
                <span className="gradient-text">ResumeAI Pro</span>
              </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              >
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  ...
                  <span className="gradient-text">50K+ Users</span>
                </h2>
                <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                  <p>
                    Founded in 2024 by <strong>Usman Murtaza</strong>, ResumeAI Pro was born from a frustrating observation: 
                    countless qualified candidates were being filtered out by Applicant Tracking Systems 
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Our core values shape everything we do at ResumeAI Pro
              </p>
            </motion.div>
              ...
              <Card className="p-8 md:p-10">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="flex gap-3 justify-center md:justify-start">
                      ...
                      <a
                        href="https://linkedin.com/in/usmanmurtaza01"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                      >
                      ...
                      <a
                        href="mailto:usman@resumeai.pro"
                        className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                      >
                ...
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-center text-sm text-gray-500 mt-2">
                    — Usman Murtaza, Founder of ResumeAI Pro
                  </p>
                </div>
              </Card>
            </motion.div>
